...
import iterator.IteratorImplementation;
...
public class BLFacadeImplementation  implements BLFacade {
    ...
    */
	...
	public Erreklamazio ErreklamazioaSortu(Erreklamazio erreklamazioa) {
		dbManager.open();
		Erreklamazio erreklamazio=dbManager.ErreklamazioaSortu(erreklamazioa);
		dbManager.close();
		return erreklamazio;
	}
	...
	public void driverBaloratu(int erreserbakode) {
	 ...
	 public boolean isDriverBaloratua(int erreserbakode) {
		...
		@WebMethod public ExtendedIterator<String> getDepartingCitiesIterator() {
		    List<String> hiriak = getDepartCities();
			Vector<String> cities = new Vector<String>(hiriak);
		    return new IteratorImplementation<String>(cities);
		}
